...
<html>
    ...
    <body> 
            ...
            <div id="panel_in_header">
                ...
                <nav>                   
                    <div class="menu">
                        ...
                        <a href="certyfikaty.php"><div class="menu_lista kolor_text_menu">Certyfikaty</div></a>
        ...
        <div id="panel_tlo">
            ...
            <div class="panel_strona_o_firmie przesuniecie_od_gory">
                <div class="panel_glowny_o_firmie">
                    <h1>Certyfikaty</h1>
                    <p class="text_panele">
                        Firma AN-FARB posiada następujące certyfikaty zgodności:
                    </p>
                    <?PHP include('../tresc/certyfikaty.html'); ?>
            ...
            <div id="panel_images_down_o_firmie">
        ...
        <div id="panel_menu_mobile">
            ...
            <a href="certyfikaty.php"><div class="menu_lista_mobile">Certyfikaty</div></a>
