...
<html>
    ...
    <body> 
            ...
            <div id="panel_in_header">
                ...
                <nav>                   
                    <div class="menu">
                        ...
                        <a href="kontakt.php"><div class="menu_lista kolor_text_menu">Kontakt</div></a>
                    </div>
                </nav>
        ...
        <div id="panel_tlo">
            ...
            <div class="panel_strona_o_firmie przesuniecie_od_gory">
                <div class="panel_glowny_o_firmie">
                    ...
                    <?PHP include('../tresc/kontakt.html'); ?>
        ...
        <div id="panel_menu_mobile">
            ...
            <a href="kontakt.php"><div class="menu_lista_mobile">Kontakt</div></a>
