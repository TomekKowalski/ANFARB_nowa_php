    ...
    <body> 
        ...
        <header id="header">
            <div id="panel_in_header">
                ...
                <nav>                   
                    <div class="menu">
                        <a href="o_firmie.php"><div class="menu_lista kolor_text_menu">O firmie</div></a>
                        ...
                        <tr>
                            <td>
                                <div id="text_lewy_o_firmie">
                                        ...
                                        <?PHP include('../tresc/ofirmie_a.html'); ?>
                            ...
                            <td class="wyrownaj">
                                <div id="text_prawy_o_firmie">
                                        ...
                                        <?PHP include('../tresc/ofirmie_b.html'); ?>
        ...
        <div id="panel_menu_mobile">
            <a href="o_firmie.php"><div class="menu_lista_mobile">O firmie</div></a>
