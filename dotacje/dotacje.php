...
<html>
    ...
    <body> 
            ...
            <div id="panel_in_header">
                ...
                <nav>                   
                    <div class="menu">
                        ...
                        <a href="dotacje.php"><div class="menu_lista kolor_text_menu">Dotacje</div></a>
        ...
        <div id="panel_tlo">
            ...
            <div class="panel_strona_o_firmie przesuniecie_od_gory">
                <div class="panel_glowny_o_firmie">
                    ...
                    <?PHP include('../tresc/dotacje_a.html'); ?>
        ...
        <div id="panel_menu_mobile">
            ...
            <a href="dotacje.php"><div class="menu_lista_mobile">Dotacje</div></a>
